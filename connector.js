...
var SELECT_TEAM_MATCHES_AFTER_DATE_STATEMENT  = "SELECT * FROM csvdata WHERE MATCH_DATE >= %1 AND (HOME_TEAM = %2 OR AWAY_TEAM = %2) AND STATUS = 'Sched' ORDER BY MATCH_DATE ASC";
