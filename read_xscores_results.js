		...
		for (var i=0; i<self.fixtures.length; i++) {
			...
			if (self.fixtures[i] !== undefined && self.fixtures[i].fixtures !== undefined) {
				for (var j=0; j<self.fixtures[i].fixtures.length; j++) {
					console.log(self.fixtures[i].fixtures[j][1] + '  ' + self.fixtures[i].fixtures[j][3] + '  ' + self.fixtures[i].date + '  ' + self.fixtures[i].fixtures[j][4] + '  ' + self.fixtures[i].fixtures[j][7] + '  ' + self.fixtures[i].fixtures[j][11]);
					var input = {};
